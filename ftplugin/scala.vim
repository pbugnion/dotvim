...
" Taken and adapted from Derek Wyatt's repository.
...
nmap <buffer> <silent> <leader>of :ScalaSwitchHere<cr>
nmap <buffer> <silent> <leader>ol :ScalaSwitchRight<cr>
nmap <buffer> <silent> <leader>oL :ScalaSwitchSplitRight<cr>
nmap <buffer> <silent> <leader>oh :ScalaSwitchLeft<cr>
nmap <buffer> <silent> <leader>oH :ScalaSwitchSplitLeft<cr>
nmap <buffer> <silent> <leader>ok :ScalaSwitchAbove<cr>
nmap <buffer> <silent> <leader>oK :ScalaSwitchSplitAbove<cr>
nmap <buffer> <silent> <leader>oj :ScalaSwitchBelow<cr>
nmap <buffer> <silent> <leader>oJ :ScalaSwitchSplitBelow<cr>
